...
const { modificar, obtenerTodo } = useArticulosStore()
...
onMounted(async () => {
    ...
    articulos.value = await obtenerTodo()
...
<template>
    <div v-if="articulo" class="crear-articulo-container">
        <h2>Modificar Artículo</h2>
        <form
            class="crear-articulo-form"
            @submit.prevent="modificar(articulo, Number(articulo.id))"
        >
